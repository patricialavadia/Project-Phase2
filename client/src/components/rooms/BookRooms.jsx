...
const BookCustomers = function (props) {
    ...
    const handleSubmit = async event => {
      ...
      try {
        const resp = await Axios.post('/api/rooms/bookCustomers', inputs);
        ...
        toast("There was an issue saving the reservation error: " + error, {
          type: toast.TYPE.ERROR
        });
      }
    };
